...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["ismail", "Chrome", "3.0"];
  ...
  client.on("open", () => {
    success("2", "Tersambung√, Hai owner ismail👋");
  });
  ...
  fs.writeFileSync(
    ...
    JSON.stringify(client.base64EncodedAuthInfo(), null, "\t")
        ...
        ownerNumber = ["083805279906@s.whatsapp.net",`083805279906@s.whatsapp.net`]
        dtod = "083805279906@s.whatsapp.net"
       otod = `083805279906@s.whatsapp.net`

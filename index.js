...
dana = "083805279906"
namabot = "ismail bot";
linkimg = "https://telegra.ph/file/9ec7d0d662465b14c6858.jpg";
/*ITU YG DI ATAS LINK IMAGENYA DONASI DANA YA KAWAN*/
grupct = "FB.COM/ISMAIL.ZXSAM";
owner = "083805279906";
nama_owner = "m ismail";
instagram = "ismail832.id";
yt = "https://youtube.com/channel/UCo-X2L6tomlBHAnM90EcT7w";
fake = "ismail bot";
  ...
  try {
      ...
      message: {
        productMessage: {
          product: {
            ...
            title: "ismail", //Kasih namalu
            description: "SELF BOT",
            currencyCode: "USD",
            priceAmount1000: "2000",
            retailerId: "IsmailSyah",
            productImageCount: 1,
          },
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "083805279906@s.whatsapp.net";
...
`;
        sendButImage(from, menu, "by @Ismail  ❤️", thumb, [
          {
      ...
      case "owner":
        ...
        sendButMessage(
          ...
          [
            ...
            {
              buttonId: `${prefix}igstalk ismail832.id`,
              buttonText: {
...
case "tod":
  if (isBanned) return reply(mess.ban)
					...
					sendButImage(from, arasyagans, "Case By @Ismail", thumb, [
          {
...
case 'fftext': 				
				...
				syaa.sendMessage(from, dapuhy, image, { quoted: mek, caption: 'Nih Jangan Lupa Follow Ig cal_me_Ismail' })
				break
case 'kbbi':	
...
case "suit":
  if (isBanned) return reply(mess.ban)
  sendButMessage(from, `Pilih Gunting Kertas Atau Batu`, `case By @Ismail`, [
          {
...
Silahkan pilih, apakah kamu mau aku kirim virtex?`, `Virtex By @Ismail`, [
          {
...
case "report":
                    ...
                    syaa.sendMessage('083805279906@s.whatsapp.net', options, text, {quoted: mek})
...
break
					case "narutopekok":
					  if (args.length == 0) return reply(`Usage: ${prefix + command} text\nExample: ${prefix}coffecup Ismail`)
                    babi = args.join(" ")
                    reply("wait")
                    buffer = await getBuffer(`https://hardianto-chan.herokuapp.com/api/photooxy/coffe-cup?apikey=hardianto&text=${babi}`)
                    syaa.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan lupa follow ig @cal_me_Ismail', quoted: mek})
                break
case "attp":
  if (isBanned) return reply(mess.ban)
...
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
				...
				break
case "bahasa"://FIXED BY Ismail
case "kodebahasa"://FIXED BY Ismail
case "code"://FIXED BY Ismail
if (isBanned) return reply(mess.ban)
...
case 'donat':
  ...
  ├─ ❏ 083805279906
  ├─ ❏ *INSTAGRAM*
  └─ ❏ https://www.instagram.com/@Ismail832.id`)
  ...
  if (isBanned) return reply(mess.ban)
		...
		case "dare":
		  if (isBanned) return reply(mess.ban)
					...
					sendButImage(from, der, "Case By ismail_\nmau lagi? tekan tombol di bawah", thumb, [
          {
            buttonId: `${prefix}dare`,
            buttonText: {
              displayText: `Dare😆`,
...
• ${prefix}fitnah
• ${prefix}fitnahpc
• ${prefix}kontak 083805279906|Ismail
• ${prefix}jadian
• ${prefix}
• ${prefix}tod
• ${prefix}truth
...
case "peraturan2":
					// Fix Case by Arasyaaa
					sya = await getBuffer(`https://telegra.ph/file/9ec7d0d662465b14c6858.jpg`)
					syaa.sendMessage(from, sya, image, { quoted: mek, caption: `Ismail bot merupakan suatu program bot whatsapp, yang menggunakan engine nodejs v14.x.x
Adapun ketentuan untuk memakai Ismail bot. :
...
case "naruto2":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix + command} Ismail Ganteng`)
				reply('Bentar lagi di proses')
...
case "pubglogo":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}pubglogo Ismail|Ganz`)
...
*Model* : ${i.phone.device_model}\n\n`;
      ...
      case "grup":
        ...
        break;
        case "scismail":
        reply(`https://youtube.com/channel/UCo-X2L6tomlBHAnM90EcT7w`)
        break
...
case 'tiktokvid':
    ...
    Follower: ${i.result.stats.followerCount}`;
     ...
     /* case "waifu":
      ...
      case "aeshtetic":
      case "wallpaperanime":
        sendButMessage(from, `Random Image by @ismail bot`, `press the button below`, [
          {
        ...
        break
case "bis":
  sendButMessage(from, `Random Image by @ismail`, `press the button below`, [
          {
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "colong":
        ...
        media = await syaa.downloadAndSaveMediaMessage(encmedia);
        anu = args.join(" ").split("|");
        satu = anu[0] !== "" ? anu[0] : `ismail`;
        dua = typeof anu[1] !== "undefined" ? anu[1] : `@ismail`;
...
${
  descOwner
    ...
    : "*Desc diubah oleh* : -"
        ...
        break
if (budy.startsWith('@083805279906')){
